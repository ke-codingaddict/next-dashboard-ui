...
const Navbar = () => {
  return (
    <div className="flex items-center justify-between p-4">
      ...
      <div className="flex horizontal gap-6 justify-end w-full">
        ...
        <div className="bg-white rouded-full w-7 h-7 flex items-center justify-center cursor-pointer relative">
          ...
          <div className="absolute -top-3 -right-3 w-5 h-5 flex items-center text-xs  bg-purple-500 text-white rounded-full text justify-center">
            1
          </div>
        </div>
